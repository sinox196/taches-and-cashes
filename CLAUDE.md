...
**Remboursement de débours carries an optional label** (`disbursementsLabel`, capped at 120 chars). The amount — `(8)` in the cascade — already existed; what was missing was any way to say *what* was advanced. It is free text beside the amount, printed under the line in the PDF when set, and it changes no arithmetic.
