      ...
      <div className="overflow-auto flex-1 min-h-0 sm:min-h-[260px] border border-gray-200 rounded-lg">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-indigo-50 sticky top-0">
            <tr>
              {hasPermission('MANAGE_LEAVE_REQUESTS') && <th className="px-6 py-3 text-left text-xs font-medium text-indigo-700 uppercase tracking-wider">Employé</th>}
              <th className="px-6 py-3 text-left text-xs font-medium text-indigo-700 uppercase tracking-wider">Responsable</th>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-indigo-700 uppercase tracking-wider">Durée</th>
